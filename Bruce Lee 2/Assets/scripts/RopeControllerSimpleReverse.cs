...
public class RopeControllerSimpleReverse : MonoBehaviour
{
    //Objects that will interact with the rope
    public Transform whatTheRopeIsConnectedToReverse;
    public Transform whatIsHangingFromTheRopeReverse;
    ...
    void Start()
    {
        ...
        springJoint = whatIsHangingFromTheRopeReverse.GetComponent<SpringJoint>();
        ...
        whatTheRopeIsConnectedToReverse.GetComponent<Rigidbody>().mass = loadMass;
    }
    ...
    private void DisplayRope()
    {
        ...
        Vector3 A = whatIsHangingFromTheRopeReverse.position;
        Vector3 D = whatTheRopeIsConnectedToReverse.position;

        //Upper control point
        //To get a little curve at the top than at the bottom
        Vector3 B = A + whatIsHangingFromTheRopeReverse.up * (-(A - D).magnitude * 0.1f);
        //B = A;

        //Lower control point
        Vector3 C = D + whatTheRopeIsConnectedToReverse.up * ((A - D).magnitude * 0.5f);
        ...
        //positions[0] = whatIsHangingFromTheRopeReverse.position;
        //positions[1] = whatTheRopeIsConnectedToReverse.position;
    ...
    {
        //Vector3 startPos = whatIsHangingFromTheRopeReverse.position;
        //Vector3 endPos = whatTheRopeIsConnectedToReverse.position;
